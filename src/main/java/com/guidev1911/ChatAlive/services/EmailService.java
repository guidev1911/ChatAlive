        ...
        try {
            ...
            String htmlContent =
                    "<p>Olá,</p>" +
                            ...
                            "<p><strong>Seu código de confirmação é:</strong> <span style='font-size: 16px; color: #28a745;'><strong>" + code + "</strong></span></p>" +
        ...
        try {
            ...
            String htmlContent =
                    "<p>Olá,</p>" +
                            ...
                            "<p><strong>Seu código de verificação é:</strong> <span style='font-size: 16px; color: #007bff;'><strong>" + code + "</strong></span></p>" +
                            "<p>⚠️ Este código é válido por apenas <strong>5 minutos</strong>.</p>" +
